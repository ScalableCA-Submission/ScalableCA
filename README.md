...
The directory named `cnf_benchmarks/` contains all 122 testing benchmarks and the directory named `non_binary_instances/` contains all 25 non-binary instances. We also provide `Benchmark_information.csv` which shows the number of options and the number of constraints for each benchmark.
